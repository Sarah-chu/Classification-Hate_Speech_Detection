...
summary(model)
# Sex is not significant , so we will remove it from the model
...
model2 <- lm(charges ~ age + bmi + children + smoker, insurance.wo.removed)
summary(model2)
summary(model)
...
# at 95% confidence, the predicted charges is between $3885.27 and $21450.6
